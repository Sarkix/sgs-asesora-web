  ...
  return (
    ...
    >
      ...
      <div className="mt-12 text-center">
        <Link href="/blog">
          <a
            className="bg-[#A97155] text-white py-3 px-8 rounded-md text-base sm:text-lg font-semibold hover:bg-opacity-80 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#A97155] focus:ring-opacity-50 inline-block"
