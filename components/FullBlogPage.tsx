...
export const BlogListPage: React.FC<BlogListPageProps> = ({ posts, isLoading, onNavigateBackToHome, onSelectPost }) => {
  return (
    <div className="min-h-screen bg-[#F8F5F0] text-[#3D3A37] antialiased">
      <header className="bg-[#EAE3D9] py-6 px-4 sm:px-8 md:px-16 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl sm:text-3xl font-bold font-sans">{personalName} - Blog</h1>
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {!isLoading && posts.map(post => (
            <button 
              ...
              className="bg-white rounded-lg shadow-xl overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-[#A97155] focus-visible:ring-offset-2 focus-visible:ring-offset-white text-left"
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#3D3A37] mb-1 group-hover:text-[#A97155] group-focus-visible:text-[#A97155] transition-colors duration-200">
                ...
                <p className="text-sm text-[#5A5653] leading-relaxed mb-4 flex-grow">
